...
<ul class="nav nav-tabs">
	<li<?php  if($do == 'heirui') { ?> class="active"<?php  } ?>><a href="<?php  echo url('cloud/heirui');?>">自动更新</a></li>
</ul>
<div class="clearfix">
	<div style="padding:15px;">
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> 更新时请注意备份网站数据和相关数据库文件！如有问题请联系QQ：151619143！
	</div>
		<?php  if($op == 'display') { ?>
<!--版本信息-->
<div class="box">
    ...
    <li>官方网站：<a href="http://bbs.heirui.cn" class="blue">黑锐源码社区</a></li>
	...
	<script type="text/javascript">
		function chanage()
		  {
			location = "<?php  echo create_url('cloud/heirui',array('op'=>'chanage'));?>";
		}
		</script>
	<?php  } ?>
    </div>
	...
	<div class="alert alert-danger">
		 <?php  if($domain_time == '0') { ?><i class="fa fa-exclamation-triangle"></i> 授权版本：授权已过期，请联系QQ:<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=151619143&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:151619143:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a><!-- WPA Button Begin -->
<script charset="utf-8" type="text/javascript" src="http://wpa.qq.com/msgrd?v=3&uin=151619143&site=qq&menu=yes"></script>
<!-- WPA Button End -->
        <?php  } else { ?>
           <i class="fa fa-refresh"></i> 授权版本：黑锐源码社区商业版 &nbsp;免费更新服务截止：(<?php  echo date("Y-m-d", $domain_time);?>)
		 <?php  } ?>
		</div>
...
<div class="box">
	...
	<script type="text/javascript">
		function disp_confirm()
		  ...
		  if (r==true)
			{
			location = "<?php  echo create_url('cloud/heirui',array('op'=>'update'));?>";
			}
		  }
...
<div class="box">
	<h3><i class="fa fa-refresh"></i> 功能模块分享</h3>
     <div class="alert alert-info" style="line-height:20px;margin-top:8px;min-height:328px;">
		<script type="text/javascript" src="http://bbs.heirui.cn/api.php?mod=js&bid=41"></script>
    </div>
</div>
